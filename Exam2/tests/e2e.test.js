...
describe('E2E tests', function () {
    ...
    describe('User Profile Page [ 10 Points ]', async () => {
        ...
        it('Check profile page for with 0 theaters [ 5 Points ]', async () => {
    ...
    describe('BONUS : Like functionality  [ 10 Points ]', async () => {
        ...
        it('Like button is visible for the non-creator user [ 2 Points ]', async () => {
            ...
            expect(await page.isVisible('text="Like"')).to.be.true;
        });
        ...
        it('Like button should increase total likes by 1 after a click on it [ 3 Points ]', async () => {
            ...
            let likes = await page.$$eval('.buttons .likes', t => t.map(s => s.textContent));
            expect(likes[0]).to.contains('Like: 5');
            ownLikes(1)
            totalLikes(6)
            await page.waitForTimeout(interval);
            ...
            likes = await page.$$eval('.buttons .likes', t => t.map(s => s.textContent));
            expect(likes[0]).to.contains('Like: 6');
            await page.waitForTimeout(interval);
